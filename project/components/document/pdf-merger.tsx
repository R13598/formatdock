    ...
    return (
      <div className="max-w-2xl rounded-2xl border border-border bg-card p-6 sm:p-8">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-foreground">PDF Merger</h2>
        </div>
        <p className="mt-2 text-sm text-muted-foreground">Drop multiple PDFs to extract and visually rearrange all pages before merging.</p>
        ...
        >
          ...
          <p className="mt-1.5 text-xs text-muted-foreground">Add 2 or more PDF files to merge</p>
      ...
      <div className="rounded-2xl border border-border bg-card p-6 sm:p-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="text-lg font-bold text-foreground">PDF Merger</h2>
              <p className="text-xs text-muted-foreground">{files.length} files · {pages.length} pages · Drag to reorder</p>
            </div>
          </div>
          ...
          <button
            onClick={() => inputRef.current?.click()}
            className="inline-flex items-center gap-1.5 rounded-lg border border-border bg-muted/40 px-3 py-2 text-xs font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
          >
        ...
        <div className="mt-6 flex flex-wrap gap-2">
          ...
          <button
            onClick={reset}
            disabled={busy}
            className="inline-flex items-center gap-2 rounded-lg border border-border bg-muted/40 px-4 py-2.5 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground disabled:opacity-50"
          >
