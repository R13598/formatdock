    ...
    <div className="max-w-4xl">
      <div className="rounded-2xl border border-border bg-card p-6 sm:p-8">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-foreground">Split PDF</h2>
        </div>
        ...
        {!file ? (
          ...
          >
            ...
            <p className="mt-1.5 text-xs text-muted-foreground">Select specific pages to extract into a new PDF</p>
          ...
          <>
            ...
            <div className="mt-4 flex flex-wrap items-center gap-3">
              <button
                onClick={selectAll}
                className="inline-flex items-center gap-1.5 rounded-lg border border-border bg-muted/40 px-3 py-1.5 text-xs font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
              >
                Select All
              </button>
              <button
