    ...
    <div className="mx-auto max-w-sm">
      <div className="rounded-2xl border border-[#1e293b] bg-[#0f172a] p-6">
        <div className="mb-4 flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-slate-400">Standard Calculator</span>
        </div>

        {/* Display */}
        <div className="mb-4 overflow-hidden rounded-xl border border-[#1e293b] bg-[#020617] px-5 py-6 text-right">
          {prev !== null && op && (
            <div className="text-xs text-slate-500">{prev} {op}</div>
          )}
          <div className="truncate text-4xl font-bold tabular-nums text-white sm:text-5xl">
          ...
          {keys.map((k) => (
            <button
              ...
              className={cn(
                ...
                k.variant === 'num' && 'border border-[#1e293b] bg-[#1e293b]/50 text-white hover:bg-[#334155]',
                k.variant === 'fn' && 'bg-[#2563EB]/15 text-[#3B82F6] hover:bg-[#2563EB]/25',
                k.variant === 'op' && 'bg-[#2563EB]/20 text-[#3B82F6] hover:bg-[#2563EB]/30',
